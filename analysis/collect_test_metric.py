...
for method in results_table.items():
    ...
    plt.plot(dim_list[1:],recon_list[1:],'-o', ms=10, label=labe)    # plt.errorbar(dim_list, FID_list, yerr=error_list, fmt='.'); # NB if error is not nan you can plot this 
...
plt.title
plt.tight_layout()
plt.savefig(savedir+'/recon_vs_dim_forced_{}.pdf'.format(DATASET), bbox_inches='tight')
